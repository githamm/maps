! function() {
    ...
    a.modules = {},
        ...
        a.register("calvinmetcalf-setImmediate/lib/index.js", function(a, b, c) {
            ...
            var h = function(a) {
                var b, c;
                return arguments.length > 1 && "function" == typeof a && (c = Array.prototype.slice.call(arguments, 1),
                        c.unshift(void 0),
                        a = a.bind.apply(a, c)),
                    1 === (b = g.push(a)) && e(d),
                    b
            ...
            function d(a) {
                ...
                function h(a, b) {
                    for (var d, h, i = a ? "resolve" : "reject", j = 0, m = k.length; m > j; j++)
                        d = k[j],
                        h = d[i],
                        "function" == typeof h ? g(f, h, b, d.resolver, d.rejecter) : a ? d.resolver(b) : d.rejecter(b);
                    l = e(c, b, a)
                }
...
L.Util.ajax = function(url, options) {
        ...
        var request, cancel, out = L.Util.Promise(function(resolve, reject) {
            ...
            request = new Ajax,
                ...
                request.onreadystatechange = function() {
                    4 === request.readyState && (request.status < 400 && options.local || 200 === request.status ? (window.JSON ? response = JSON.parse(request.responseText) : options.evil && (response = eval("(" + request.responseText + ")")),
                        resolve(response)) : request.status ? reject(request.statusText) : reject("Attempted cross origin request without CORS enabled"))
                },
                request.send()
        });
    ...
    L.Util.jsonp = function(a, b) {
        ...
        var c, d, e, f, g = document.getElementsByTagName("head")[0],
            ...
            i = L.Util.Promise(function(i, j) {
                ...
                b.callbackName ? c = b.callbackName : (e = "_" + ("" + Math.random()).slice(2),
                        c = "L.Util.jsonp.cb." + e),
    ...
    L.GeoJSON.AJAX = L.GeoJSON.extend({
        ...
        initialize: function(a, b) {
            this.urls = [],
                a && ("string" == typeof a ? this.urls.push(a) : "function" == typeof a.pop ? this.urls = this.urls.concat(a) : (b = a,
                    a = void 0));
        ...
        refilter: function(a) {
            "function" != typeof a ? (this.filter = !1,
