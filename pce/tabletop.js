(function(global) {
  ...
  /*
    Initialize with Tabletop.init( { key: '0AtVsEW-ZbKySdHN5YzdHZlRCam9YeWN2MWRZVkZxd0E' } )
      OR!
    Initialize with Tabletop.init( { key: 'https://docs.google.com/spreadsheet/pub?hl=en_US&hl=en_US&key=0AjAPaAU9MeLFdHUxTlJiVVRYNGRJQnRmSnQwTlpoUXc&output=html&widget=true' } )
      OR!
    Initialize with Tabletop.init('0AtVsEW-ZbKySdHN5YzdHZlRCam9YeWN2MWRZVkZxd0E')
  */
